...
const contexts = {
  ...
  'admin/buku.ejs': {
    title: 'Buku', currentUser: sampleUser, buku: [{ id: 1, judul: 'J', penulis: 'P', kategori: 'K', stok: 2, lokasi: 'L' }],
    search: '', message: null, error: null,
  },
  'admin/edit-buku.ejs': { title: 'Edit', currentUser: sampleUser, buku: { id: 1, judul: 'J', penulis: 'P', penerbit: null, tahun_terbit: 2000, kategori: 'K', stok: 2, lokasi: null }, error: null },
  ...
  'user/katalog.ejs': { title: 'Katalog', currentUser: sampleSiswa, buku: [{ id: 1, judul: 'J', penulis: 'P', kategori: 'K', stok: 2 }], pinjamIds: new Set(), search: '', message: null, error: null },
  'user/peminjaman.ejs': { title: 'Pinjam', currentUser: sampleSiswa, buku: [{ id: 1, judul: 'J', penulis: 'P', kategori: 'K', stok: 2 }], pinjamIds: new Set(), search: '', message: null, error: null },
