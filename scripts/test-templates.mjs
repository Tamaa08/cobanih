...
const contexts = {
  ...
  'admin/transaksi.ejs': {
    ...
    transaksi: [{ id: 1, status: 'pending', buku: { judul: 'J' }, anggota: { nama: 'N' }, tanggal_pinjam: new Date().toISOString(), tanggal_kembali: new Date().toISOString() }],
    buku: [{ id: 1, judul: 'J', penulis: 'P' }], anggota: [{ id: 1, nama: 'N', nis: 'X' }],
    search: '', status: '', statusList: ['pending', 'dipinjam', 'menunggu_kembali', 'dikembalikan', 'ditolak'], countPending: 1, message: null, error: null,
  },
  ...
  'admin/bantuan.ejs': {
    title: 'Bantuan', currentUser: sampleUser,
    tiket: [{ id: 't1', status: 'menunggu', subjek: 'S', pesan: 'P', jawaban: null, created_at: new Date().toISOString(), pengirim: { nama: 'Budi', username: 'budi' }, penjawab: null }],
    statusFilter: '', statusList: ['menunggu', 'dibalas', 'selesai'],
    belumBalas: 1, tableReady: true, message: null, error: null,
  },
  'admin/pengaturan.ejs': { title: 'Pengaturan', currentUser: sampleUser, dendaPerHari: 10000, tableReady: true, message: null, error: null },
  'user/dashboard.ejs': {
  ...
  'user/detail.ejs': { title: 'Detail', currentUser: sampleSiswa, buku: { id: 1, judul: 'J', penulis: 'P', penerbit: 'X', tahun_terbit: 2000, kategori: 'K', stok: 2, lokasi: 'L', cover_url: null, rating: 4.2, rating_count: 3, deskripsi: 'Inti buku.' }, myRating: 5, myKomentar: 'Bagus', canRate: true, terpinjam: false, daftarRating: [{ nilai: 5, komentar: 'Bagus', anggota: { nama: 'Budi' } }], message: null, error: null },
