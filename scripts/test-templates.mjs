...
const contexts = {
  ...
  'admin/bantuan.ejs': {
    ...
    belumBalas: 1, message: null, error: null,
  },
  'user/dashboard.ejs': {
  ...
  'user/bantuan.ejs': { title: 'Bantuan', currentUser: sampleSiswa, tiket: [{ status: 'menunggu', subjek: 'S', pesan: 'P', jawaban: null, created_at: new Date().toISOString() }], message: null, error: null },
